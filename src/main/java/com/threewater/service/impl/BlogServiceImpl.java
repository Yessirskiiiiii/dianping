...
import com.threewater.dto.ScrollResult;
import com.threewater.dto.UserDTO;
import com.threewater.entity.Blog;
import com.threewater.entity.Follow;
...
import com.threewater.service.IFollowService;
...
import static com.threewater.utils.RedisConstants.BLOG_LIKED_KEY;
import static com.threewater.utils.RedisConstants.FEED_KEY;
...
public class BlogServiceImpl extends ServiceImpl<BlogMapper, Blog> implements IBlogService {
    ...
    public Result queryBlogOfFollow(Long max, Integer offset) {
        // 1. 获取当前用户id
        Long userId = UserHolder.getUser().getId();
        // 2. 查询邮件箱 ZREVRANGEBYSCORE key Max Min LIMIT offset count
        String key = FEED_KEY + userId;
