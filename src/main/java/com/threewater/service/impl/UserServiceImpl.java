...
import com.threewater.utils.RegexUtils;
...
import static com.threewater.utils.SystemConstants.USER_NICK_NAME_PREFIX;
...
public class UserServiceImpl extends ServiceImpl<UserMapper, User> implements IUserService {
    ...
    public Result sendCode(String phone, HttpSession session) {
        ...
        // 4. 保存验证码到 redis
        stringRedisTemplate.opsForValue().set(LOGIN_CODE_KEY + phone, code, LOGIN_CODE_TTL, TimeUnit.MINUTES); // 设置验证码2分钟有效期
        // 5. 发送验证码
